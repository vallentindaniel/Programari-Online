...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 13, 2019 at 10:08 AM
...
INSERT INTO `doctori` (`id`, `username`, `password`) VALUES
(1, 'Marian', '$2y$10$txNwdjeIo.hShnZzA179NuhZBQjjyCLs8Uk00tivHKf5ds8HiVyL6'),
(2, 'Grosaru Robert', '$2y$10$SyT6Zrriia8ykYwsrRby/uXvoGrDJwZ.acMT7PAa9JR7Dyq.f6EYG');
...
--
-- Table structure for table `lunile_anului`
--
...
--
-- Dumping data for table `lunile_anului`
--
...
INSERT INTO `programari` (`id`, `id_jud`, `id_loc`, `id_spital`, `id_sectie`, `ora_select`, `zi_select`, `luna_select`, `an_select`, `nume`, `prenume`, `data_zi`, `data_luna`, `data_an`, `telefon`, `id_sesiune`) VALUES
(1, 1, 1, 1, 1, 13, 13, 2, 2019, 'dhd', 'gfjgf', 1, 'Ianuarie', 2018, '0725568899', 1),
(2, 1, 1, 1, 1, 14, 13, 2, 2019, 'dhd', 'gfjgf', 1, 'Ianuarie', 2018, '0725568899', 1),
(3, 1, 1, 1, 1, 15, 13, 2, 2019, 'Valentin', 'Andrei', 1, 'Ianuarie', 2018, '0725568899', 4),
(4, 1, 2, 2, 2, 8, 14, 2, 2019, 'Marian', 'fsdfd', 1, 'Ianuarie', 2018, '0725568899', 1),
(5, 1, 2, 2, 2, 9, 14, 2, 2019, 'Valentin', 'Andrei', 1, 'Ianuarie', 2018, '0725568899', 1);

-- --------------------------------------------------------

--
-- Table structure for table `programari_id`
--
...
--
-- Dumping data for table `spitale`
--
...
(4, 'Valentin', '$2y$10$f8GZ36AIZf/e8yYCzNXK8eIBl59Fo7ZlytSUApqV4VVusOfavaqDi');

-- --------------------------------------------------------

--
-- Table structure for table `zile_sapt`
--
...
--
-- Dumping data for table `zile_sapt`
--
